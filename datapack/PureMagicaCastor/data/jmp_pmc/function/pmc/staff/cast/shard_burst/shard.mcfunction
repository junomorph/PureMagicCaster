...
execute positioned ~-0.875 ~-0.875 ~-0.875 as @e[dx=0,type=!#jmp_pmc:not_mob,tag=!jmp_pmc.barriered] positioned ~0.75 ~0.75 ~0.75 if entity @s[dx=0] run damage @s 1 jmp_pmc:instant_damage
